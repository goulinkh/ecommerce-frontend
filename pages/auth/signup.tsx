    ...
    <Layout navbar={false} footer={false}>
      ...
      <div className="w-screen h-screen md:flex md:flex-row items-center justify-center">
        ...
        <AuthFormContainer>
          ...
          <div className="w-full flex flex-col space-y-4 items-start justify-between">
          ...
          <div className="w-full flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-4 pb-8 md:pb-0 items-center">
